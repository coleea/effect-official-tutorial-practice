...
const makeEntry = (request, result, listeners, ownerId, state) => new EntryImpl(request, result, listeners, ownerId, state);
/** @internal */
...
const parallelCollectionCombine = (self, that) => new ParallelImpl(HashMap.reduceWithIndex(self.map, that.map, (map, value, key) => HashMap.set(map, key, Option.match(() => value, a => [...a, ...value])(HashMap.get(map, key)))));
/** @internal */
...
const sequentialCollectionCombine = (self, that) => new SequentialImpl(HashMap.reduceWithIndex(that.map, self.map, (map, value, key) => HashMap.set(map, key, Option.match(() => [], a => [...a, ...value])(HashMap.get(map, key)))));
/** @internal */
