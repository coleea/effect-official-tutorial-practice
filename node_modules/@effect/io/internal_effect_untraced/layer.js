...
/** @internal */
const scope = () => {
  return scopedContext(core.map(scope => Context.make(Scope.Scope, scope))(fiberRuntime.acquireRelease(fiberRuntime.scopeMake(), (scope, exit) => scope.close(exit))));
};
/** @internal */
exports.scope = scope;
