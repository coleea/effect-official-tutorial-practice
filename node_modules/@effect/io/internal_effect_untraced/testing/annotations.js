...
exports.make = exports.isAnnotations = exports.AnnotationsTypeId = exports.Annotations = void 0;
  ...
  supervisedFibers() {
    return Debug.bodyWithTrace(trace => effect.descriptorWith(descriptor => core.flatMap(either => {
      switch (either._tag) {
        ...
        case "Right":
          {
            return core.map(SortedSet.filter(fiber => !Equal.equals(fiber.id(), descriptor.id)))(core.map(RA.reduce(SortedSet.empty(fiber.Order), (a, b) => SortedSet.union(b)(a)))(core.forEach(ref => core.sync(() => MutableRef.get(ref)))(either.right)));
          }
      }
...
/** @internal */
const Annotations = /*#__PURE__*/Context.Tag( /*#__PURE__*/Symbol.for("@effect/test/Annotations"));
/** @internal */
