...
var _fiberId = /*#__PURE__*/require("@effect/io/internal_effect_untraced/fiberId");
...
/** @internal */
const makeCacheStats = (hits, misses, size) => ({
  hits,
  misses,
  size
});
...
_b = CacheTypeId;
/** @internal */
const make = /*#__PURE__*/Debug.methodWithTrace((trace, restore) => (capacity, timeToLive, lookup) => makeWith(capacity, restore(lookup), () => timeToLive).traced(trace).traced(trace));
/** @internal */
exports.make = make;
const makeWith = /*#__PURE__*/Debug.methodWithTrace((trace, restore) => (capacity, lookup, timeToLive) => core.map(effect.all(core.context(), core.fiberId()), ([context, fiberId]) => new CacheImpl(capacity, context, fiberId, restore(lookup), restore(timeToLive))).traced(trace));
/** @internal */
exports.makeWith = makeWith;
const unsafeMakeWith = (capacity, lookup, timeToLive) => new CacheImpl(capacity, Context.empty(), _fiberId.none, lookup, timeToLive);
