...
var _blockedRequests = /*#__PURE__*/_interopRequireWildcard( /*#__PURE__*/require("@effect/io/internal_effect_untraced/blockedRequests"));
...
/* @internal */
exports.die = die;
const dieMessage = /*#__PURE__*/Debug.methodWithTrace(trace => message => failCauseSync(() => internalCause.die(internalCause.RuntimeException(message))).traced(trace));
/* @internal */
...
const exit = /*#__PURE__*/Debug.methodWithTrace(trace => self => matchCause(cause => exitFailCause(cause), a => exitSucceed(a))(self).traced(trace));
/* @internal */
exports.exit = exit;
...
const step = /*#__PURE__*/Debug.methodWithTrace(trace => self => {
...
/* @internal */
exports.step = step;
const flatMapStep = /*#__PURE__*/Debug.methodWithTrace(trace => (self, f) => {
  const effect = new EffectPrimitive("OnStep");
  effect.i0 = self;
  effect.i1 = f;
  return effect.traced(trace);
...
const forEach = /*#__PURE__*/Debug.dualWithTrace(2, (trace, restore) => (self, f) => suspend(() => {
  ...
  let i = 0;
  return as(ret)(whileLoop(() => i < arr.length, () => restore(f)(arr[i]), b => {
    ret[i++] = b;
  }));
}).traced(trace));
/* @internal */
...
const if_ = /*#__PURE__*/Debug.dualWithTrace(3, trace => (self, onTrue, onFalse) => (self ? onTrue : onFalse).traced(trace));
/* @internal */
exports.if_ = if_;
...
const interruptibleMask = /*#__PURE__*/Debug.methodWithTrace((trace, restore) => f => {
  ...
  effect.i1 = oldFlags => _runtimeFlags.interruption(oldFlags) ? step(restore(f)(interruptible)) : step(restore(f)(uninterruptible));
  // @ts-expect-error
...
/* @internal */
exports.map = map;
const mapBoth = /*#__PURE__*/Debug.dualWithTrace(3, (trace, restore) => (self, f, g) => matchEffect(self, e => failSync(() => restore(f)(e)), a => sync(() => restore(g)(a))).traced(trace));
/* @internal */
...
const provideSomeContext = /*#__PURE__*/Debug.dualWithTrace(2, trace => (self, context) => fiberRefLocallyWith(currentContext, parent => Context.merge(parent, context))(self).traced(trace));
/* @internal */
...
const withParallelism = /*#__PURE__*/Debug.dualWithTrace(2, trace => (self, parallelism) => fiberRefLocally(self, currentParallelism, parallelism === "unbounded" ? Option.none() : Option.some(parallelism)).traced(trace));
/* @internal */
...
const resolverLocally = /*#__PURE__*/Debug.untracedDual(3, restore => (use, self, value) => new RequestResolverImpl(requests => fiberRefLocally(restore(use.runAll)(requests), self, value), Chunk.make("Locally", use, self, value)));
/** @internal */
...
/* @internal */
const fiberRefLocally = /*#__PURE__*/Debug.dualWithTrace(3, trace => (use, self, value) => flatMap(acquireUseRelease(zipLeft(fiberRefGet(self), fiberRefSet(self, value)), () => step(use), oldValue => fiberRefSet(self, oldValue)), res => {
  if (res._tag === "Blocked") {
...
const currentLogSpan = /*#__PURE__*/(0, _Global.globalValue)( /*#__PURE__*/Symbol.for("@effect/io/FiberRef/currentLogSpan"), () => fiberRefUnsafeMake(Chunk.empty()));
/** @internal */
...
const withScheduler = /*#__PURE__*/Debug.dualWithTrace(2, trace => (self, scheduler) => fiberRefLocally(self, currentScheduler, scheduler).traced(trace));
/** @internal */
exports.withScheduler = withScheduler;
const currentParallelism = /*#__PURE__*/(0, _Global.globalValue)( /*#__PURE__*/Symbol.for("@effect/io/FiberRef/currentParallelism"), () => fiberRefUnsafeMake(Option.none()));
/** @internal */
exports.currentParallelism = currentParallelism;
const currentUnhandledErrorLogLevel = /*#__PURE__*/(0, _Global.globalValue)( /*#__PURE__*/Symbol.for("@effect/io/FiberRef/currentUnhandledErrorLogLevel"), () => fiberRefUnsafeMake(Option.some(logLevelDebug), _ => _, (_, x) => x));
/** @internal */
exports.currentUnhandledErrorLogLevel = currentUnhandledErrorLogLevel;
const withUnhandledErrorLogLevel = /*#__PURE__*/Debug.dualWithTrace(2, trace => (self, level) => fiberRefLocally(self, currentUnhandledErrorLogLevel, level).traced(trace));
/** @internal */
...
const currentForkScopeOverride = /*#__PURE__*/(0, _Global.globalValue)( /*#__PURE__*/Symbol.for("@effect/io/FiberRef/currentForkScopeOverride"), () => fiberRefUnsafeMake(Option.none(), () => Option.none(), (parent, _) => parent));
/** @internal */
exports.currentForkScopeOverride = currentForkScopeOverride;
const currentInterruptedCause = /*#__PURE__*/(0, _Global.globalValue)( /*#__PURE__*/Symbol.for("@effect/io/FiberRef/currentInterruptedCause"), () => fiberRefUnsafeMake(internalCause.empty, () => internalCause.empty, (parent, _) => parent));
// -----------------------------------------------------------------------------
// Scope
// -----------------------------------------------------------------------------
/** @internal */
...
const exitCollectAllInternal = (exits, combineCauses) => {
  ...
  return Option.some(exitMap(chunk => Array.from(chunk))(exitMap(Chunk.reverse)(Chunk.reduce(exitMap(Chunk.of)(Chunk.headNonEmpty(list)), (accumulator, current) => exitZipWith(current, (list, value) => Chunk.prepend(value)(list), combineCauses)(accumulator))(Chunk.tailNonEmpty(list)))));
};
// -----------------------------------------------------------------------------
// Deferred
// -----------------------------------------------------------------------------
