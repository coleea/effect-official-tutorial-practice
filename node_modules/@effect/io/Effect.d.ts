...
declare const try_: <A>(evaluate: LazyArg<A>) => Effect<never, unknown, A>;
export { 
/**
...
export declare const cachedInvalidateWithTTL: {
    (timeToLive: Duration.Duration): <R, E, A>(self: Effect<R, E, A>) => Effect<R, never, [Effect<never, E, A>, Effect<never, never, void>]>;
    <R, E, A>(self: Effect<R, E, A>, timeToLive: Duration.Duration): Effect<R, never, [Effect<never, E, A>, Effect<never, never, void>]>;
};
 ...
 * @category constructors
 */
export declare const allSuccesses: <R, E, A>(as: Iterable<Effect<R, E, A>>) => Effect<R, never, Array<A>>;
/**
 ...
 * @category constructors
 */
export declare const allSuccessesPar: <R, E, A>(elements: Iterable<Effect<R, E, A>>) => Effect<R, never, Array<A>>;
/**
 ...
 * @category constructors
 */
export declare const collectAll: <R, E, A>(elements: Iterable<Effect<R, E, Option.Option<A>>>) => Effect<R, E, Array<A>>;
/**
 * Collects the all element of the `Collection<A>` for which the effect returns a value.
 *
 * @since 1.0.0
 * @category constructors
 */
export declare const collectAllPar: <R, E, A>(elements: Iterable<Effect<R, E, Option.Option<A>>>) => Effect<R, E, Array<A>>;
/**
...
export declare const bindDiscard: {
    <N extends string, K, R2, E2, A>(tag: Exclude<N, keyof K>, f: Effect<R2, E2, A>): <R, E>(self: Effect<R, E, K>) => Effect<R2 | R, E2 | E, MergeRecord<K, {
        [k in N]: A;
    }>>;
    <R, E, N extends string, K, R2, E2, A>(self: Effect<R, E, K>, tag: Exclude<N, keyof K>, f: Effect<R2, E2, A>): Effect<R | R2, E | E2, MergeRecord<K, {
        [k in N]: A;
    }>>;
};
declare const bindValue_: {
...
export declare const letDiscard: {
    <N extends string, K, A>(tag: Exclude<N, keyof K>, f: A): <R, E>(self: Effect<R, E, K>) => Effect<R, E, MergeRecord<K, {
        [k in N]: A;
    }>>;
    <R, E, K, N extends string, A>(self: Effect<R, E, K>, tag: Exclude<N, keyof K>, f: A): Effect<R, E, MergeRecord<K, {
        [k in N]: A;
    }>>;
};
/**
...
export declare const ensuringChild: {
    <R2, X>(f: (fiber: Fiber.Fiber<any, Array<unknown>>) => Effect<R2, never, X>): <R, E, A>(self: Effect<R, E, A>) => Effect<R2 | R, E, A>;
    <R, E, A, R2, X>(self: Effect<R, E, A>, f: (fiber: Fiber.Fiber<any, Array<unknown>>) => Effect<R2, never, X>): Effect<R | R2, E, A>;
};
/**
...
export declare const ensuringChildren: {
    <R1, X>(children: (fibers: Array<Fiber.RuntimeFiber<any, any>>) => Effect<R1, never, X>): <R, E, A>(self: Effect<R, E, A>) => Effect<R1 | R, E, A>;
    <R, E, A, R1, X>(self: Effect<R, E, A>, children: (fibers: Array<Fiber.RuntimeFiber<any, any>>) => Effect<R1, never, X>): Effect<R | R1, E, A>;
};
/**
...
export declare const forEachExec: {
    <R, E, A, B>(f: (a: A) => Effect<R, E, B>, strategy: ExecutionStrategy.ExecutionStrategy): (elements: Iterable<A>) => Effect<R, E, Array<B>>;
    <R, E, A, B>(elements: Iterable<A>, f: (a: A) => Effect<R, E, B>, strategy: ExecutionStrategy.ExecutionStrategy): Effect<R, E, Array<B>>;
};
/**
 ...
 * @category supervision
 */
export declare const forkAll: <R, E, A>(effects: Iterable<Effect<R, E, A>>) => Effect<R, never, Fiber.Fiber<E, Array<A>>>;
/**
 * Returns an effect that forks all of the specified values, and returns a
...
export interface Adapter {
    ...
    <A, B, C, D, E, F, G, _R, _E, _A>(a: A, ab: (a: A) => B, bc: (b: B) => C, cd: (c: C) => D, de: (d: D) => E, ef: (e: E) => F, fg: (f: F) => G, gh: (g: F) => Effect<_R, _E, _A>): EffectGen<_R, _E, _A>;
 ...
 * @category constructors
 */
export declare const gen: <Eff extends EffectGen<any, any, any>, AEff>(f: (resume: Adapter) => Generator<Eff, AEff, any>) => Effect<[
    Eff
...
declare const if_: {
    <R1, R2, E1, E2, A, A1>(onTrue: Effect<R1, E1, A>, onFalse: Effect<R2, E2, A1>): (self: boolean) => Effect<R1 | R2, E1 | E2, A | A1>;
    <R1, R2, E1, E2, A, A1>(self: boolean, onTrue: Effect<R1, E1, A>, onFalse: Effect<R2, E2, A1>): Effect<R1 | R2, E1 | E2, A | A1>;
};
/**
 ...
 * @category constructors
 */
export declare const loop: <Z, R, E, A>(initial: Z, cont: (z: Z) => boolean, inc: (z: Z) => Z, body: (z: Z) => Effect<R, E, A>) => Effect<R, E, Array<A>>;
/**
...
export declare const mapAccum: {
    <A, B, R, E, Z>(zero: Z, f: (z: Z, a: A) => Effect<R, E, readonly [Z, B]>): (elements: Iterable<A>) => Effect<R, E, [Z, Array<B>]>;
    <A, B, R, E, Z>(elements: Iterable<A>, zero: Z, f: (z: Z, a: A) => Effect<R, E, readonly [Z, B]>): Effect<R, E, [Z, Array<B>]>;
};
/**
...
export declare const repeatOrElseEither: {
    <R2, A extends A0, A0, B, E, R3, E2, C>(schedule: Schedule.Schedule<R2, A0, B>, orElse: (error: E, option: Option.Option<B>) => Effect<R3, E2, C>): <R>(self: Effect<R, E, A>) => Effect<R2 | R3 | R, E2, Either.Either<C, B>>;
    <R, E, A extends A0, A0, R2, B, R3, E2, C>(self: Effect<R, E, A>, schedule: Schedule.Schedule<R2, A0, B>, orElse: (error: E, option: Option.Option<B>) => Effect<R3, E2, C>): Effect<R | R2 | R3, E2, Either.Either<C, B>>;
};
/**
 ...
 * @category utils
 */
export declare const replicate: (n: number) => <R, E, A>(self: Effect<R, E, A>) => Array<Effect<R, E, A>>;
/**
...
export declare const timedWith: {
    <R1, E1>(milliseconds: Effect<R1, E1, number>): <R, E, A>(self: Effect<R, E, A>) => Effect<R1 | R, E1 | E, [Duration.Duration, A]>;
    <R, E, A, R1, E1>(self: Effect<R, E, A>, milliseconds: Effect<R1, E1, number>): Effect<R | R1, E | E1, [Duration.Duration, A]>;
};
/**
 ...
 * @category constructors
 */
export declare const tryCatchPromise: <E, A>(evaluate: LazyArg<Promise<A>>, onReject: (reason: unknown) => E) => Effect<never, E, A>;
/**
 ...
 * @category constructors
 */
export declare const tryCatchPromiseInterrupt: <E, A>(evaluate: (signal: AbortSignal) => Promise<A>, onReject: (reason: unknown) => E) => Effect<never, E, A>;
/**
 ...
 * @category constructors
 */
export declare const tryPromiseInterrupt: <A>(evaluate: (signal: AbortSignal) => Promise<A>) => Effect<never, unknown, A>;
/**
...
export declare namespace All {
    ...
    type ReturnArray<T> = [T] extends [ReadonlyArray<EffectAny>] ? Effect<T[number] extends never ? never : [T[number]] extends [{
        [EffectTypeId]: {
            _R: (_: never) => infer R;
        };
    ...
    type ReturnTuple<T extends ReadonlyArray<Effect<any, any, any>>> = Effect<T[number] extends never ? never : [T[number]] extends [{
        [EffectTypeId]: {
            _R: (_: never) => infer R;
        };
    }] ? R : never, T[number] extends never ? never : [T[number]] extends [{
    ...
    type ReturnIterable<T> = [T] extends [[Iterable<EffectAny>]] ? [T] extends [[ReadonlyArray<EffectAny>]] ? ReturnTuple<T[0]> : Effect<[
        T[0]
    ] extends [Iterable<{
        [EffectTypeId]: {
            _R: (_: never) => infer R;
    ...
    }>]] ? Effect<keyof T[0] extends never ? never : [T[0][keyof T[0]]] extends [{
        [EffectTypeId]: {
            _R: (_: never) => infer R;
        };
    ...
    type Signature = {
        <Args extends ReadonlyArray<EffectAny> | [Iterable<EffectAny>] | [Readonly<{
            [K: string]: Effect<any, any, any>;
        }>]>(...args: [...Args]): Args["length"] extends 1 ? Args extends [Iterable<EffectAny>] ? ReturnIterable<Args> : Args extends [EffectAny] ? ReturnArray<Args> : ReturnObject<Args> : ReturnArray<Args>;
    };
    type Discard<X> = [X] extends [Effect<infer R, infer E, infer _>] ? Effect<R, E, void> : never;
    type SignatureDiscard = {
        <Args extends ReadonlyArray<EffectAny> | [Iterable<EffectAny>] | [Readonly<{
            [K: string]: Effect<any, any, any>;
        }>]>(...args: [...Args]): Discard<Args["length"] extends 1 ? Args extends [Iterable<EffectAny>] ? ReturnIterable<Args> : Args extends [EffectAny] ? ReturnArray<Args> : ReturnObject<Args> : ReturnArray<Args>>;
    };
}
/**
 ...
 * @category constructors
 */
export declare const unfold: <A, R, E, S>(s: S, f: (s: S) => Effect<R, E, Option.Option<readonly [A, S]>>) => Effect<R, E, Array<A>>;
/**
 * @since 1.0.0
 * @category interruption
 */
...
export declare const bindTo: {
    <N extends string>(name: N): <O, E, A>(self: Effect<O, E, A>) => Effect<O, E, {
        [K in N]: A;
    }>;
    <O_1, E_1, A_1, N_1 extends string>(self: Effect<O_1, E_1, A_1>, name: N_1): Effect<O_1, E_1, {
        [K_1 in N_1]: A_1;
    }>;
};
/**
...
export declare const nonEmptyStruct: <R extends {
    readonly [x: string]: Effect<any, any, any>;
}>(fields: (keyof R extends never ? never : R) & {
    readonly [x: string]: Effect<any, any, any>;
}) => Effect<[
    R[keyof R]
] extends [Effect<infer O, any, any>] ? O : never, [
    R[keyof R]
] extends [Effect<any, infer E, any>] ? E : never, {
 ...
 * @since 1.0.0
 */
export declare const nonEmptyTuple: <T extends readonly [Effect<any, any, any>, ...Array<Effect<any, any, any>>]>(...elements: T) => Effect<[
    T[number]
] extends [Effect<infer O, any, any>] ? O : never, [
    T[number]
] extends [Effect<any, infer E, any>] ? E : never, {
