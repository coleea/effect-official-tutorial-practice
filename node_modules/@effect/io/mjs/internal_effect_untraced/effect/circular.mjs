...
/** @internal */
export const acquireReleaseInterruptible = /*#__PURE__*/Debug.methodWithTrace((trace, restore) => (acquire, release) => fiberRuntime.ensuring(acquire, fiberRuntime.addFinalizer(restore(release))).traced(trace));
/** @internal */
...
/** @internal */
export const ensuringChildren = /*#__PURE__*/Debug.dualWithTrace(2, (trace, restore) => (self, children) => core.flatMap(supervisor.track(), supervisor => fiberRuntime.ensuring(core.flatMap(supervisor.value(), restore(children)))(supervised(supervisor)(self))).traced(trace));
/** @internal */
...
/** @internal */
export const raceEither = /*#__PURE__*/Debug.dualWithTrace(2, trace => (self, that) => fiberRuntime.race(core.map(self, Either.left), core.map(that, Either.right)).traced(trace));
/** @internal */
export const raceFirst = /*#__PURE__*/Debug.dualWithTrace(2, trace => (self, that) => (effect => core.flatten(effect))(fiberRuntime.race(core.exit(that))(core.exit(self))).traced(trace));
/** @internal */
...
/** @internal */
export const validatePar = /*#__PURE__*/Debug.dualWithTrace(2, trace => (self, that) => validateWithPar(self, that, (a, b) => tuple(a, b)).traced(trace));
/** @internal */
...
/** @internal */
export const zipWithPar = /*#__PURE__*/Debug.dualWithTrace(3, (trace, restoreTrace) => (self, that, f) => core.map(fiberRuntime.allPar(self, that), ([a, a2]) => restoreTrace(f)(a, a2)).traced(trace));
