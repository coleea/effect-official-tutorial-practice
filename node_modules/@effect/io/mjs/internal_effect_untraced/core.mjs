...
/* @internal */
export const dieMessage = /*#__PURE__*/Debug.methodWithTrace(trace => message => failCauseSync(() => internalCause.die(internalCause.RuntimeException(message))).traced(trace));
/* @internal */
...
/* @internal */
export const exit = /*#__PURE__*/Debug.methodWithTrace(trace => self => matchCause(cause => exitFailCause(cause), a => exitSucceed(a))(self).traced(trace));
/* @internal */
...
/* @internal */
export const step = /*#__PURE__*/Debug.methodWithTrace(trace => self => {
...
/* @internal */
export const flatMapStep = /*#__PURE__*/Debug.methodWithTrace(trace => (self, f) => {
  const effect = new EffectPrimitive("OnStep");
  effect.i0 = self;
  effect.i1 = f;
  return effect.traced(trace);
...
/* @internal */
export const if_ = /*#__PURE__*/Debug.dualWithTrace(3, trace => (self, onTrue, onFalse) => (self ? onTrue : onFalse).traced(trace));
/* @internal */
...
/* @internal */
export const mapBoth = /*#__PURE__*/Debug.dualWithTrace(3, (trace, restore) => (self, f, g) => matchEffect(self, e => failSync(() => restore(f)(e)), a => sync(() => restore(g)(a))).traced(trace));
/* @internal */
...
/* @internal */
export const provideSomeContext = /*#__PURE__*/Debug.dualWithTrace(2, trace => (self, context) => fiberRefLocallyWith(currentContext, parent => Context.merge(parent, context))(self).traced(trace));
/* @internal */
...
/* @internal */
export const withParallelism = /*#__PURE__*/Debug.dualWithTrace(2, trace => (self, parallelism) => fiberRefLocally(self, currentParallelism, parallelism === "unbounded" ? Option.none() : Option.some(parallelism)).traced(trace));
/* @internal */
...
// end
/** @internal */
export const resolverLocally = /*#__PURE__*/Debug.untracedDual(3, restore => (use, self, value) => new RequestResolverImpl(requests => fiberRefLocally(restore(use.runAll)(requests), self, value), Chunk.make("Locally", use, self, value)));
/** @internal */
...
/* @internal */
export const fiberRefLocally = /*#__PURE__*/Debug.dualWithTrace(3, trace => (use, self, value) => flatMap(acquireUseRelease(zipLeft(fiberRefGet(self), fiberRefSet(self, value)), () => step(use), oldValue => fiberRefSet(self, oldValue)), res => {
  if (res._tag === "Blocked") {
...
/** @internal */
export const currentLogSpan = /*#__PURE__*/globalValue( /*#__PURE__*/Symbol.for("@effect/io/FiberRef/currentLogSpan"), () => fiberRefUnsafeMake(Chunk.empty()));
/** @internal */
...
/** @internal */
export const withScheduler = /*#__PURE__*/Debug.dualWithTrace(2, trace => (self, scheduler) => fiberRefLocally(self, currentScheduler, scheduler).traced(trace));
/** @internal */
export const currentParallelism = /*#__PURE__*/globalValue( /*#__PURE__*/Symbol.for("@effect/io/FiberRef/currentParallelism"), () => fiberRefUnsafeMake(Option.none()));
/** @internal */
export const currentUnhandledErrorLogLevel = /*#__PURE__*/globalValue( /*#__PURE__*/Symbol.for("@effect/io/FiberRef/currentUnhandledErrorLogLevel"), () => fiberRefUnsafeMake(Option.some(logLevelDebug), _ => _, (_, x) => x));
/** @internal */
export const withUnhandledErrorLogLevel = /*#__PURE__*/Debug.dualWithTrace(2, trace => (self, level) => fiberRefLocally(self, currentUnhandledErrorLogLevel, level).traced(trace));
/** @internal */
export const currentTags = /*#__PURE__*/fiberRefUnsafeMakeHashSet( /*#__PURE__*/HashSet.empty());
/** @internal */
export const currentForkScopeOverride = /*#__PURE__*/globalValue( /*#__PURE__*/Symbol.for("@effect/io/FiberRef/currentForkScopeOverride"), () => fiberRefUnsafeMake(Option.none(), () => Option.none(), (parent, _) => parent));
/** @internal */
export const currentInterruptedCause = /*#__PURE__*/globalValue( /*#__PURE__*/Symbol.for("@effect/io/FiberRef/currentInterruptedCause"), () => fiberRefUnsafeMake(internalCause.empty, () => internalCause.empty, (parent, _) => parent));
// -----------------------------------------------------------------------------
// Scope
// -----------------------------------------------------------------------------
/** @internal */
