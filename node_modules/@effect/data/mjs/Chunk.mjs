 ...
 * @category filtering
 */
export const filterMap = /*#__PURE__*/Dual.dual(2, (self, f) => unsafeFromArray(RA.filterMap(self, f)));
/**
 * Returns a filtered and mapped subset of the elements.
 *
 * @since 1.0.0
 * @category filtering
 */
export const filter = /*#__PURE__*/Dual.dual(2, (self, predicate) => unsafeFromArray(RA.filterMap(self, O.liftPredicate(predicate))));
/**
 * Returns a filtered and mapped subset of the elements.
 *
 * @since 1.0.0
 * @category filtering
 */
export const filterMapWithIndex = /*#__PURE__*/Dual.dual(2, (self, f) => unsafeFromArray(RA.filterMap(self, f)));
/**
 ...
 * @category elements
 */
export const elem = /*#__PURE__*/Dual.dual(2, (self, b) => elem_(toReadonlyArray(self), b));
/**
 ...
 * @category elements
 */
export const findFirst = /*#__PURE__*/Dual.dual(2, (self, predicate) => RA.findFirst(toReadonlyArray(self), predicate));
/**
 ...
 * @category elements
 */
export const findFirstIndex = /*#__PURE__*/Dual.dual(2, (self, f) => RA.findFirstIndex(toReadonlyArray(self), f));
/**
 * Find the first index for which a predicate holds
 *
 * @since 1.0.0
 * @category elements
 */
export const findLastIndex = /*#__PURE__*/Dual.dual(2, (self, f) => RA.findLastIndex(toReadonlyArray(self), f));
/**
 ...
 * @category elements
 */
export const findLast = /*#__PURE__*/Dual.dual(2, (self, f) => RA.findLast(toReadonlyArray(self), f));
/**
 ...
 * @category elements
 */
export const intersection = /*#__PURE__*/Dual.dual(2, (self, that) => unsafeFromArray(intersection_(toReadonlyArray(self), toReadonlyArray(that))));
/**
 ...
 * @category mapping
 */
export const map = /*#__PURE__*/Dual.dual(2, (self, f) => self.backing._tag === "ISingleton" ? of(f(self.backing.a)) : unsafeFromArray(RA.map(toReadonlyArray(self), f)));
/**
 * Returns an effect whose success is mapped by the specified f function.
 *
 * @since 1.0.0
 ...
 * @category elements
 */
export const union = /*#__PURE__*/Dual.dual(2, (self, that) => unsafeFromArray(union_(toReadonlyArray(self), toReadonlyArray(that))));
 ...
 * @category elements
 */
export const dedupe = self => unsafeFromArray(uniq_(toReadonlyArray(self)));
/**
 ...
 * @since 1.0.0
 */
export const zipWithIndex = self => zipWithIndexOffset(self, 0);
/**
 * Zips this chunk with the index of every element, starting from the initial
 * index value.
 *
