 ...
 * @since 1.0.0
 */
export const EitherTypeId = /*#__PURE__*/Symbol.for("@effect/data/Either");
/**
 ...
 * @since 1.0.0
 */
export const orElseEither = /*#__PURE__*/dual(2, (self, that) => {
  if (isLeft(self)) {
 ...
 * @since 1.0.0
 */
export const traverse = F => dual(2, (self, f) => isLeft(self) ? F.of(left(self.left)) : F.map(f(self.right), right));
/**
 * @category instances
 * @since 1.0.0
 */
